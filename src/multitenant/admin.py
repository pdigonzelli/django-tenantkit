...
from multitenant.models import Tenant, TenantInvitation, TenantMembership, TenantSetting
...
class TenantAdmin(SoftDeleteAdminMixin, SharedScopeModelAdmin):
    ...
    change_form_template = "admin/multitenant_tenant_change_form.html"
    list_display = (
        "deleted_status",
        "slug",
        "name",
    ...
    class Media:
        js = ("multitenant/admin/tenant_form.js",)
    ...
    def delete_selected_tenants_with_databases(self, request, queryset):
        ...
        return render(request, "admin/multitenant_tenant_bulk_delete.html", context)
    ...
    def tenant_operation_view(self, request, object_id: str, operation: str):
        ...
        return render(
            request,
            "admin/multitenant_tenant_operation.html",
            {
                **self.admin_site.each_context(request),
    ...
    def delete_view(self, request, object_id, extra_context=None):
        ...
        if request.method == "POST":
            ...
            if confirm_text != expected_text:
                ...
                return render(
                    request,
                    "admin/multitenant_tenant_delete_confirmation.html",
                    context,
                )
        ...
        return render(
            request, "admin/multitenant_tenant_delete_confirmation.html", context
        )
...
multitenant_admin_site.register(Tenant, TenantAdmin)
multitenant_admin_site.register(TenantMembership, TenantMembershipAdmin)
multitenant_admin_site.register(TenantInvitation, TenantInvitationAdmin)
multitenant_admin_site.register(TenantSetting, TenantSettingAdmin)
